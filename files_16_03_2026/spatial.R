...
save_object <- function(object, filename) {
  saveRDS(object, file = file.path(object_dir, filename))
}
...
save_object(brca_sp, "01_brca_sp_clustered.rds")
...
save_object(brca_sc, "02_brca_sc_processed.rds")
...
save_object(brca_sp, "03_brca_sp_transferred.rds")
...
save_object(brca_sdwls_res, "04_brca_sdwls_res_final.rds")
